...
```sh
npm install git+ssh://git@github.com:NebelNite/Azure.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/NebelNite/Azure/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/NebelNite/Azure/issues) with questions, bugs, or suggestions.
