...
[![NPM version](https://img.shields.io/npm/v/try.svg)](https://npmjs.org/package/try) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/try)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/try-node.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install try`
...
To do the inverse, add `import "try/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/try-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/try-node/issues) with questions, bugs, or suggestions.
